...
/**
 * Utility class for creating and managing Solana keypairs.
 * Provides static factory methods for different keypair creation scenarios.
 */
export class Keypair {
     ...
     * ```
     */
    static async fromSecretKey(secretKey: Uint8Array | number[] | ReadonlyUint8Array): Promise<KeyPairSigner> {
     ...
     * ```
     */
    static async fromBase58(base58String: string): Promise<KeyPairSigner> {
        ...
        try {
            ...
            return await this.fromSecretKey(secretKey);
        } catch (error) {
